...
% Global variables
% -------------------------------------------------------------------------
global help_icon parent_figure
...
uicontrol(file_select_box, 'units', 'normalized', 'style', 'pushbutton', ...
    'position', [0.35 0.04 0.35 0.15], 'String', 'Create Database', ...
...
uicontrol(file_select_box, 'units', 'normalized', 'style', 'edit', ...
    'position', [0.23 0.04 0.15 0.15], 'String', num2str(num_rois), ...
    'callback', @get_num_rois);

uicontrol(file_select_box, 'units', 'normalized', 'style', 'pushbutton', ...
    'position', [0.55 0.04 0.40 0.15], 'String', 'Calculate Overlap', ...
...
wait_box = figure('units', 'normalized', 'position', ...
    [0.56 0.60 0.08 0.05], 'Name', title, 'numbertitle', 'off', ...
    'MenuBar', 'none');
